...
# Train the model
checkpoint = ModelCheckpoint('/content/gdrive/My Drive/inception_fine_tuned.keras', monitor='val_accuracy', save_best_only=True, mode='max', verbose=1)
...
model = load_model('/content/gdrive/My Drive/inception_fine_tuned.h5')
...
# Load the pre-trained model
model = load_model('/content/gdrive/My Drive/inception_fine_tuned_final.h5')
